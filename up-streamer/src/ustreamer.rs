...
type InTransportOutAuthorities = Arc<Mutex<HashMap<(ComparableTransport, UAuthority), usize>>>;
...
impl UStreamer {
    ...
    ///                        and the worker tasks for each currently routed `UTransport`
    pub fn new(name: &str, message_queue_size: usize) -> Self {
        ...
        Self {
            ...
            in_transport_out_authorities: Arc::new(Mutex::new(HashMap::new())),
            message_queue_size,
        }
    }
