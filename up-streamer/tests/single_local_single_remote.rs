...
use integration_test_utils::{
    ...
    publish_from_remote_client_for_local_client, remote_authority_a, remote_client_uuri,
    ...
    wait_for_pause, ClientCommand, LocalClientListener, RemoteClientListener, UPClientFoo,
};
use log::debug;
...
async fn single_local_single_remote() {
    ...
    let local_handle = run_client(
        ...
        vec![notification_from_local_client_for_remote_client(
            10,
            remote_client_uuri(remote_authority_a(), 200),
        )],
        vec![request_from_local_client_for_remote_client(
            10,
            remote_client_uuri(remote_authority_a(), 200),
        )],
        vec![response_from_local_client_for_remote_client(
            10,
            remote_client_uuri(remote_authority_a(), 200),
        )],
        true,
    ...
    let remote_handle = run_client(
        ...
        remote_client_listener_trait_obj,
        tx_2.clone(),
        rx_2.clone(),
        ...
        true,
        all_signal_should_pause.clone(),
        remote_signal_has_paused.clone(),
